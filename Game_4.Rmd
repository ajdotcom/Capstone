...
```{r data}
load("~/Desktop/Capstone/Data/gl4_df.rda") # Game Log (2/2/20)
```

### This table displays Player Statisics for Game (2/2/2020)
...
### This table displays Advanced Player Statisics for Game (2/2/2020)
```{r}
# Advanced Game Log 
gltable <- plot_ly(
  type = 'table',
