...
```{r data}
load("~/Desktop/Capstone/Data/gl2_df.rda") # Game Log (12/31/2019)
```

### This table displays Player Statisics for Game (12/31/2019)
...
gltable <- plot_ly(
  ...
  fill = list(color = "rgba(192, 192, 192, 0.7)"),
...
### This table displays Advanced Player Statisics for Game (12/31/2019)
```{r}
# Advanced Game Log 
gltable <- plot_ly(
  type = 'table',
