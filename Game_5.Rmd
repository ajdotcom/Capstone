...
```{r data}
load("~/Desktop/Capstone/Data/gl5_df.rda") # Game Log (2/8/2020)
```

### This table displays Player Statisics for Game (2/8/2020)
...
### This table displays Advanced Player Statisics for Game (2/8/2020)
```{r}
# Advanced Game Log 
gltable <- plot_ly(
  type = 'table',
